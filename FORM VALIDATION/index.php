<?php
	$con = mysqli_connect("localhost","primex","123456","primex");
...
<title>Registration pagae and Login</title>
</head>
<body>
	<div id="container">
    	<div class="login">
        ...
        <form method="post" action="index.php">
        	<table>
                ...
                <tr>
                    ...
                    <td colspan="1" align="center" bgcolor="#339900"><p>Go Back Home <a href="../index.php">Home</a></p></td>
                </tr>
